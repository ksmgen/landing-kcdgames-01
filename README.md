...
- `demo` deploys to Azure Blob Static Website from GitHub Actions, stamps `out/index.html` with an epoch release marker, logs the preview URL, and can notify Telegram on completion
