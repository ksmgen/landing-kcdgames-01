...
- Retailer flow images mirrored from the source retailer page live in `public/retailer/`; themed retailer mobile app badges are surfaced on the retailer flow page.
