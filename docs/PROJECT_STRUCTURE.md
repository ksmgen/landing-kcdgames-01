...
- `src/app/retailer/page.tsx`: KC Games themed retailer pre-signup page that leads into the live Betobee signup, serves Malaysia & Brunei, and declares retailer canonical metadata.
...
- `src/components/RetailerSearch.tsx`: Retailer directory search, All/Playing Locations filters, and dynamic region navigation chips.
- `src/data/retailers.json`: Retailer records with region, country, and playing-location flags.
