...
- `public/`: Static site assets such as the logo, hero banner, retailer images, and campaign banners.
...
- `src/app/page.tsx`: Landing experience with hero, Riftbound launch announcement, services, mission, benefits, and contact section.
