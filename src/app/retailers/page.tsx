...
export const metadata: Metadata = {
  ...
  description:
    "Find 188 authorised KC Games Riftbound TCG retailers across Malaysia and Brunei. Filter by store type — all stores, hobby gaming stores, or retail only stores — and get directions to your nearest stockist.",
  alternates: {
  ...
  openGraph: {
    title: "Authorised Riftbound Retailers in Malaysia & Brunei | KC Games",
    description:
      "Find 188 authorised KC Games Riftbound TCG retailers across Malaysia and Brunei. Search by state, filter by store type, and get directions to your nearest stockist.",
    type: "article",
    url: "/retailers.html",
    siteName: "KC Games",
    locale: "en_MY",
