        ...
        <section>
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-silver-400/25 bg-[linear-gradient(135deg,rgba(24,49,73,0.96),rgba(8,25,42,0.98))] p-5 shadow-card sm:p-6 lg:p-7">
                ...
                <div className="relative grid gap-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
                  <div className="flex items-center gap-4 text-left">
                    ...
                    <div>
                      <p className="text-xs font-bold uppercase tracking-[0.25em] text-silver-400">Retailer mobile access</p>
                      ...
                      >
                        {link.platform === "apple" ? (
                          <svg className="h-8 w-8 shrink-0 fill-current" viewBox="0 0 384 512" aria-hidden="true">
                            <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C83.3 140.9 39 168.9 39 225.9c0 17.2 3.1 35 9.4 53.4 8.4 23.9 38.7 82.5 70.3 81.5 16.5-.4 28.2-11.7 49.7-11.7 20.9 0 31.7 11.7 50.1 11.7 31.8-.5 59.1-53.7 67.1-77.7-42.6-20.1-67-68.4-67-113.2zM260.6 104.6c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z" />
                          </svg>
                        ) : (
                          <svg className="h-8 w-8 shrink-0" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                            <path d="M4.5 3.8v16.4L18.9 12 4.5 3.8Z" fill="currentColor" opacity="0.95" />
                            <path d="m4.5 3.8 9.1 9.1M4.5 20.2l9.1-9.1" stroke="#cbd5e1" strokeWidth="1.2" strokeLinecap="round" />
                          </svg>
                        )}
